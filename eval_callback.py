...
class EvalCallBack(Callback):
    ...
    def __init__(self, eval_function, eval_param_dict, save_best_ckpt=True,
                 ckpt_directory="./", besk_ckpt_name="STGCN-best.ckpt"):
    ...
    def end(self, run_context):
        print("End training, the best validation_loss is: {1}, the best epoch is {}".format(self.best_res,
