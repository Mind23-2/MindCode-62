...
class R2Plus1DNet(nn.Cell):
    ...
    def __init__(self, layer_sizes, block_type=SpatioTemporalResBlock):
        ...
        #self.pool = nn.AdaptiveAvgPool3d(1) # 这个算子还是pytorch版的，mindspore里面没找见对应的
        #self.pool = MaxPool3D(kernel_size=(2,7,7), strides=1, pad_mode="valid") # 临时改为3D最大池化
...
class R2Plus1DClassifier(nn.Cell):
    ...
    def construct(self, x):
        ...
        #print('输出 res2plus1d.conv1.spatial_conv.weight:\n', value)
